...
inline void GameEditor::AssignComponents(ECS::Entity* entity, const json& componentData)
{
	...
	else if constexpr (std::is_same_v<Transform, ComponentType>)
	{
		entity->Assign<ComponentType>(componentData["m_Position"], componentData["m_Rotation"], componentData["m_Scale"]);

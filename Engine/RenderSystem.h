...
class RenderSystem : public ECS::EntitySystem,
	...
	public ECS::EventSubscriber<ECS::Events::OnComponentAssigned<DynamicText>>
{
public:
	...
	virtual void Receive(ECS::World* world, const ECS::Events::OnComponentAssigned<DynamicText>& event) override;
};

...
struct DynamicText
{
	ECS_DECLARE_TYPE
		...
		//DynamicText() = default;
		explicit DynamicText(const int index = 0)
		: m_TextNum(index)
	{}
	~DynamicText() = default;
	...
	{
		{
			...
			L"큰일이다! 저택에서는 간단하게 위험한 장소에 갈 수 있는데...",
			L"도깨비들이 거실로 모여 다급하게 회의를 했다.",
			L" 오랜만의 대공사였다! 힘들었지만, 김서방이 돌아다니는 모습을 보니 흐뭇한 미소가 지어졌다.",
			L"그나저나 현관을 이렇게 길게 만들어놓은 놈은 누구야?",
			L"어떤 멍청한 놈이 본관 들어가는 길을 이렇게 복잡하게 만드냐고!"
		},
		{
		...
		},
		{
			...
			L"잠을 자는 공간, 밥을 먹는 공간, 노는 공간.",
			L"우리 도깨비들이 가장 사랑하는 세 개의 공간이고, 일상의 대부분을 보내는 곳이다.",
			L"그런데 세 공간이 떨어져 있어 우리는 잠에서 깨어난 뒤, 밥을 먹으러 이동하고, 놀러 이동해야 했다!",
			L"그때, 한 도깨비가 기가 막힌 발상을 떠올린다.",
			L"그러면... 그 모든 걸 한 공간에 할 수 있게 하면 되는 거 아닐까?!",
			L"아주 좋은 생각이었다! 우리는 바로 실행했다.",
			L"아주아주 만족스러웠고, 매우매우 훌륭했다!"
		},
		{
			L"하나 죽였다. 가족같은 존재였다.",
			L"함께 했던 모든 시간이 거짓인가? 너희들이 나에게 했던 그 행동들은 모두 장난에 불과했을까?",
			L"언제나 웃는 도깨비들... 옛날엔 천진난만하고 순수하다 생각했다.",
			L"이젠 아니다 .그 미소 속에 뭘 숨겨놓았는지 모르겠다.",
...

		{
			...
			L"김서방의 짚신 엮는 솜씨는 이제 저택에서도 따라갈 도깨비가 없을 정도다!",
			L"최근 김서방은 책에 관심을 가졌는데, 그런 김서방을 위해 도깨비들을 책을 한가득 가져왔다.",
			L"책들이 너무 많아 책을 보관하려고 서재를 지었을 정도다!",
			L"김서방을 위해 벼루와 먹, 붓을 가져왔다. 김서방은 글씨를 쓸 수 있게 됐다며 크게 기뻐했다.",
			L"김서방이 성장해 어느새 어른 그릇을 사용하게 되었다!",
			L"우리 모두, 김서방의 성장에 기뻐했다."},
		{
			L"다같이 놀고 있는 자리에서 김서방이 아주 재미있는 걸 물었다.",
			L"자신은 누구이고, 어디에서 왔으며, 부모는 누구냐는 질문.",
			L"김서방의 질문 덕에 오랫동안 잊고 있던 일을 떠올렸다. 십몇년전, 이맘때 기가 막힌 장난을 인간 부부에게 실험했었다.",
			L"화들짝 놀라고 두려워하는 모습이 얼마나 즐겁던지!",
			L"하지만... 결코 죽일 생각은 없었다.",
			L"그건 실수였다. 그 부부에게 갓난아기가 있다는 사실 역시 모르고 있었다.",
			L"나는 아기를 데려왔고 도깨비 저택에서 키우기로 했다. 아이를 키우는 건, 색다른 재미를 줄 거 같았으니까!",
			L"잊고 있었던 이야기를 나누며 형제 모두가 웃음꽃을 피웠다.",
			L"김서방의 표정이 너무 어두운 게 흠이지만... 뭐, 맛있는 거 먹고 신나게 놀다보면 나아지겠지!"},
		{
		...
		{
			L"복수를 다짐한 뒤, 내가 가장 먼저 한 건 어떻게 해야 놈들을 죽일 수 있나 연구하는 것이었다."
		},
		{
			L"첫째 삼촌을 납치해 고문했다.첫째 삼촌은 고통스러운 비명을 내지르며 비밀을 실토했다.",
			L"본체... 본체를 부러트려야 죽는다고? 난 첫째 삼촌의 본체가 어디있는지 캐물었고, 첫째 삼촌은 비밀을 실토해냈다.",
			L"첫째 삼촌의 본체를 부러트리고.",
	...
	NLOHMANN_DEFINE_TYPE_INTRUSIVE(DynamicText, m_ComponentName, m_TextNum, m_TriggerDistance, m_CurrentTextIndex, m_Text, m_IsTextShow, m_FontIndex, m_Page, m_Index)
};

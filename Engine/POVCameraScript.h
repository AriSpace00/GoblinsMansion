...
public:
	...
	virtual void Update(float deltaTime) override
	{
		...
		//bool m_IsMove = m_pOwner->get<Transform>()->m_FreezeRotationY;
		...
		if (UnLockYAxis)
		{
			...
			if (InputM->GetKey(Key::W) || InputM->GetKey(Key::A) || InputM->GetKey(Key::S) || InputM->GetKey(Key::D))
			{
